...
class Handler extends ExceptionHandler
{
     ...
     * Originally sending http response -> changed it so it will return a json response everytime (Schwarzion)
     */
    public function render($request, Exception $e)
    {
        ...
        $status = Response::HTTP_INTERNAL_SERVER_ERROR; //Setting to default error
